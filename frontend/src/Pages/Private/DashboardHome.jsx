              ...
              <ul className="whitespace-pre px-2.5 text-[0.9rem] py-5 flex flex-col gap-1 font-heading font-medium overflow-x-hidden    md:h-[68%] h-[70%]">
                <li>
                  <NavLink
                    to={"/dashboard"}
                    className={`link ${
                      isRouteActive("/dashboard") ? "bg-primary" : ""
                    }`}
                  >
                ...
                <li>
                  <NavLink
                    ...
                    className={`link ${
                      isRouteActive("/dashboard/analytics") ? "bg-primary" : ""
                    }`}
                  >
                ...
                <li>
                  <NavLink
                    ...
                    className={`link ${
                      isRouteActive("/dashboard/myBidding") ? "bg-primary" : ""
                    }`}
                  >
                ...
                <li>
                  <NavLink
                    ...
                    className={`link ${
                      isRouteActive("/dashboard/createBidding")
                        ? "bg-primary"
                        : ""
                    }`}
                  >
