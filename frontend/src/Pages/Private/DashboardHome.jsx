    ...
    <>
      <div className="flex gap-5">
        <div>
         ...
         h-screen "
          >
            <Link to='/'> <div className="flex items-center gap-4 font-medium border-b py-3 border-slate-300  mx-3">
              <img src="logo.png" width={45} alt="" />
              <span className="text-xl font-bold font-heading whitespace-pre">
                ReWaste
              </span>
            </div>
            </Link>
            <div className="flex flex-col  h-full">
              <ul className="whitespace-pre px-2.5 text-[0.9rem] py-5 flex flex-col gap-1 font-heading font-medium overflow-x-hidden    md:h-[68%] h-[70%]">
                <li>
                  <NavLink
                    to={"/dashboard"}
                    className={`link ${isRouteActive("/dashboard") ? "bg-primary" : ""
                      }`}
                  >
                ...
                <li>
                  <NavLink
                    ...
                    className={`link ${isRouteActive("/dashboard/analytics") ? "bg-primary" : ""
                      }`}
                  >
                ...
                <li>
                  <NavLink
                    to={"/dashboard/myBidding"}
                    className={`link ${isRouteActive("/dashboard/myBidding") ? "bg-primary" : ""
                      }`}
                  >
                ...
                <li>
                  <NavLink
                    to={"/dashboard/createBidding"}
                    className={`link ${isRouteActive("/dashboard/createBidding")
                      ? "bg-primary"
                      : ""
                      }`}
                  >
